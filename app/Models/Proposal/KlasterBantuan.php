...
class KlasterBantuan extends Model
{
    protected $table            = 'klaster_bantuan';
    ...
    protected $validationMessages = [
        'nama' => [
            'required' => 'Nama klaster bantuan wajib diisi.',
            'min_length' => 'Nama klaster bantuan minimal 3 karakter.',
        ],
    ];
