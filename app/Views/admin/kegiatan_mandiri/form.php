...
<div class="row g-3 admin-page">
    ...
    <div class="col-xl-12">
        <div class="card card-primary card-outline admin-form-card shadow-sm">
            ...
            <form action="<?= esc($formAction) ?>" method="post" id="form-kegiatan-mandiri" novalidate data-submit-state-form>
                <?= csrf_field() ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="besaran_dana" name="besaran_dana" class="form-control" inputmode="numeric" value="<?= esc($formValues['besaran_dana']) ?>" required data-numeric-only>
                                </div>
                ...
                <div class="card-footer admin-form-footer d-flex flex-wrap gap-2 justify-content-end">
                    <button type="submit" class="btn btn-primary" data-submit-trigger>
                        <span class="d-inline-flex align-items-center gap-2" data-submit-default-content><i class="bi bi-save"></i><span><?= esc($submitLabel) ?></span></span>
